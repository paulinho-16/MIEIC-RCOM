...
int main(int argc, char** argv)
{
    ...
    system("socat -d -d PTY,link=/dev/ttyS0,mode=777 PTY,link=/dev/emulatorTx,mode=777 &");
    sleep(1);
    printf("\n");

    system("socat -d -d PTY,link=/dev/ttyS1,mode=777 PTY,link=/dev/emulatorRx,mode=777 &");
    sleep(1);
